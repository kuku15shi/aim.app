...
<div class="app-container" style="background: transparent; box-shadow: none;">
    ...
    <div class="menu-container">
        <a href="list.php?type=government" class="menu-btn">GOVERNMENT</a>
        <a href="list.php?type=private" class="menu-btn">PRIVATE</a>
        <a href="list.php?type=laboratory" class="menu-btn">LABORATORY</a>
        <a href="list.php?type=clinic" class="menu-btn">CLINIC</a>
        <a href="list.php?type=medical_shop" class="menu-btn">MEDICAL SHOP</a>
    </div>
    </div>
